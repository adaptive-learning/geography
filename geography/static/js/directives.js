              ...
              elem.tooltip({
                ...
                title : '<div class="skill-tooltip">' +
                       ...
                       '<span class="badge badge-default">' +
                         ...
                         $scope.skills.number_of_mastered_items + ' / ' +
                         $scope.skills.number_of_items +
                       '</span>' +
                     '</div>' +
                     '<div class="skill-tooltip">' +
                       ...
                       '<span class="badge badge-default">' +
                         ...
                         ($scope.skills.number_of_nonmastered_practiced_items || 0) + ' / ' +
                         $scope.skills.number_of_items +
                       '</span>' +
                     '</div>'
              });
  ...
  .directive('levelProgressBar',['userService', '$timeout', 'gettextCatalog',
    ...
    return {
      ...
      link : function($scope, elem, attrs) {
        ...
        if (attrs.username && attrs.username != userService.user.username) {
