...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Goal'
        db.create_table(u'geography_goal', (
            ...
            ('start_probability', self.gf('django.db.models.fields.FloatField')(default=0.5)),
            ('map', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['geography.PlaceRelation'])),
            ('place_type', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal('geography', ['Goal'])


    def backwards(self, orm):
        # Deleting model 'Goal'
        db.delete_table(u'geography_goal')
    ...
    models = {
        ...
        'geography.answer': {
            ...
            'language': ('django.db.models.fields.SmallIntegerField', [], {'default': '0'}),
        ...
        'geography.goal': {
            'Meta': {'ordering': "['-id']", 'unique_together': "(('user', 'map', 'place_type'),)", 'object_name': 'Goal'},
            'finish_date': ('django.db.models.fields.DateField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'map': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['geography.PlaceRelation']"}),
            'place_type': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'start_date': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'start_probability': ('django.db.models.fields.FloatField', [], {'default': '0.5'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
        'geography.group': {
