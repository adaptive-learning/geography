...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Test'
        db.create_table(u'geography_test', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('place_test_map', self.gf('django.db.models.fields.related.ForeignKey')(related_name='place_test_map_id', to=orm['geography.Place'])),
            ('place_type', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('geography', ['Test'])
        # Adding M2M table for field places_to_ask on 'Test'
        m2m_table_name = db.shorten_name(u'geography_test_places_to_ask')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('test', models.ForeignKey(orm['geography.test'], null=False)),
            ('place', models.ForeignKey(orm['geography.place'], null=False))
        ))
        db.create_unique(m2m_table_name, ['test_id', 'place_id'])

        # Adding field 'Answer.test'
        db.add_column(u'geography_answer', 'test',
            self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['geography.Test'], null=True, blank=True),
            keep_default=False)


    def backwards(self, orm):
        # Removing M2M table for field places_to_ask on 'Test'
        db.delete_table(db.shorten_name(u'geography_test_places_to_ask'))
        # Deleting model 'Test'
        db.delete_table(u'geography_test')
        # Deleting field 'Answer.test'
        db.delete_column(u'geography_answer', 'test_id')
    ...
    models = {
        ...
        'geography.answer': {
            ...
            'test': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['geography.Test']", 'null': 'True', 'blank': 'True'}),
        ...
        'geography.mapskill': {
            'Meta': {'object_name': 'MapSkill', 'managed': 'False'},
            'dummy_id': ('django.db.models.fields.CharField', [], {'max_length': '40', 'primary_key': 'True'}),
            'learned': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'place': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['geography.Place']", 'on_delete': 'models.DO_NOTHING'}),
            'practiced': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
        ...
        'geography.test': {
            'Meta': {'unique_together': "(('place_test_map', 'place_type'),)", 'object_name': 'Test'},
            'active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'place_test_map': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'place_test_map_id'", 'to': "orm['geography.Place']"}),
            'place_type': ('django.db.models.fields.IntegerField', [], {}),
            'places_to_ask': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['geography.Place']", 'symmetrical': 'False'})
        },
        'geography.userplace': {
