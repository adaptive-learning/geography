...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Place.difficulty'
        db.add_column('core_place', 'difficulty',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'UsersPlace.difficulty'
        db.delete_column('core_usersplace', 'difficulty')


    def backwards(self, orm):
        # Deleting field 'Place.difficulty'
        db.delete_column('core_place', 'difficulty')

        # Adding field 'UsersPlace.difficulty'
        db.add_column('core_usersplace', 'difficulty',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)
